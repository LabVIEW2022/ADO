...
def sys_leak ():
    ...
    while main_leak_T != 0:
        ...
        if ML == 0:
            ...
            log('ADO_SLT_DATA', 'SLT', 'Internal Leak', '_Internal Leak', 'FAIL')
            fail += 1
            res += 1
            f = open('/home/pi/Bellwether/ADO_ODO_SLT.py', "w")
            f.write('cnt ' + '= ' + str(cnt))
        ...
        time.sleep(1)
        main_leak_T -= 1
    log('ADO_SLT_DATA', 'SLT', 'Internal Leak', '_Internal Leak', 'PASS')
    T1 = 1
    list()
...
def Manifold_leak():
    ...
    while test_timer != 0:
        ...
        if ML == 0:
            ...
            log('ADO_SLT_DATA', 'SLT', 'External Leak', '_Load Leak', 'FAIL')
            fail += 1
            res += 1
            f = open('/home/pi/Bellwether/ADO_ODO_SLT.py', "w")
            f.write('cnt ' + '= ' + str(cnt))
        ...
        time.sleep(1)
        test_timer -= 1
    log('ADO_SLT_DATA', 'SLT', 'External Leak', '_Manifold Leak', 'PASS')
    T2 = 1
    list()
    ado.V24Off()
    ado.OPN()
...
def Load_leak ():
    ...
    while test_timer != 0:
        ...
        time.sleep(1)
        test_timer -= 1
    log('ADO_SLT_DATA', 'SLT', 'External Leak', '_Load Leak', 'PASS')
    T3 = 1
    list()
...
def BD_leak ():
    ...
    while test_timer != 0:
        ...
        if ML == 0:
            ...
            ulog('BD Leak', 'FAIL', 'FAIL')
            log('ADO_SLT_DATA', 'SLT', 'External Leak', '_BD Leak', 'FAIL')
            fail += 1
            res += 1
            f = open('/home/pi/Bellwether/ADO_ODO_SLT.py', "w")
            f.write('cnt ' + '= ' + str(cnt))
        ...
        time.sleep(1)
        test_timer -= 1
    log('ADO_SLT_DATA', 'SLT', 'External Leak', '_BD Leak', 'PASS')
    T4 = 1
    list()
    GDisplay('ADO External', 'Leak Test', 'PASS', str(rev))
    ado.V24Off()
...
def Exit_OPN_leak ():
    ...
    while test_timer != 0:
        ...
        if ML == 0:
            ...
            log('ADO_SLT_DATA', 'SLT', 'External Leak', '_EX OPN Leak', 'FAIL')
        ...
        time.sleep(1)
        test_timer -= 1
    log('ADO_SLT_DATA', 'SLT', 'External Leak', '_EX OPN Leak', 'PASS')
    T5 = 1
    list()
    GDisplay('ADO External', 'Leak Test', 'PASS', str(rev))
    ado.V24Off()
...
def Chaff_Can_leak():
    ...
    while test_timer != 0:
        ...
        if ML == 0:
            ...
            log('ADO_SLT_DATA', 'SLT', 'External Leak', '_Check Valve Leak', 'FAIL')
        ...
        time.sleep(1)
        test_timer -= 1
    log('ADO_SLT_DATA', 'SLT', 'External Leak', '_Check Valve Leak', 'PASS')
    T6 = 1
    list()
